...
<p data-visibility='hidden'>View <a href='https://learn.co/lessons/cssi-3.4-jquery-basics' title='jQuery Basics'>jQuery Basics</a> on Learn.co and start learning to code for free.</p>
